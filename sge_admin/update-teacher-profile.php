                                ...
                                <div class="info-table table-responsive">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>Name:</td>
                                                <td class="font-medium text-dark-medium"><input type=text name=name size=50  class=txtbox value='<?php echo $ds['tname']; ?>'></td>
                                            </tr>
                                            <tr>
                                                <td>Degree:</td>
                                                <td class="font-medium text-dark-medium"><input type=text name=name size=50  class=txtbox value='<?php echo $ds['tdegree']; ?>'></td>
                                            </tr>
                                            <tr>
                                                <td>Designation:</td>
                                                <td class="font-medium text-dark-medium"><input type=text name=name size=50  class=txtbox value='<?php echo $ds['tdesignation']; ?>'></td>
                                            </tr>
                                            <tr>
                                                <td>Experience:</td>
                                                <td class="font-medium text-dark-medium"><input type=text name=name size=50  class=txtbox value='<?php echo $ds['experience']; ?>'></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
