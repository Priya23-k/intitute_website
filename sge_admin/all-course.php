                                ...
                                <div class="table-responsive">
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php echo $arr['totalstudent']; ?></td>
                                            <td><?php echo $arr['courseimg']; ?></td>
                                            <td>
                                            <?php echo"<a href='javascript:void(0);' data-cid='".$arr['courseid']."' class='del'> " ?>
